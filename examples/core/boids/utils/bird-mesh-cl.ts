...
const birdVS: string = readFileSync(new URL('../cl/bird-vs.glsl', import.meta.url)).toString();
const birdFS: string = readFileSync(new URL('../cl/bird-fs.glsl', import.meta.url)).toString();
