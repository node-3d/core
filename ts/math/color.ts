...
export class Color extends Vec4 {
	...
	public static rgbaFromObject(
		source: Exclude<TColorSource, string | number>,
		alpha?: number,
	): TRgba {
		let r = 0;
		let g = 0;
	...
	public get rgb(): Color {
		return new Color(this.r, this.g, this.b);
	}
	public set rgb(value: TVec3Source) {
		this.xyz = value;
	}
	...
	public set rgba(value: TVec4Source) {
		this.xyzw = value;
	}
