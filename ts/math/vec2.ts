...
const hasXY = (value: object): value is TVec2Object =>
	'x' in value && 'y' in value && typeof value.x === 'number' && typeof value.y === 'number';
...
export class Vec2 extends Array<number> {
	...
	public get clone(): this {
		return new (this.constructor as new (source: this) => this)(this);
	}

	public get xy(): Vec2 {
		return new Vec2(this);
	}
	public set xy(value: TVec2Source) {
		this[0] = value[0];
		this[1] = value[1];
	}
	...
	public added(other: TVec2Source): this {
		return this.plused(other);
	}
	public add(other: TVec2Source): this {
		return this.clone.plused(other);
	}
	...
	public subed(other: TVec2Source): this {
		return this.minused(other);
	}
	public sub(other: TVec2Source): this {
		return this.clone.minused(other);
	}
	public subtracted(other: TVec2Source): this {
		return this.minused(other);
	}
	public subtract(other: TVec2Source): this {
		return this.clone.minused(other);
	}

	public substracted(): never {
		throw new Error('Use subtract instead of sub-S-tract.');
	}
	public substract(): never {
		throw new Error('Use subtract instead of sub-S-tract.');
	}
	...
	public multiplied(other: TVec2Source): this {
		return this.muled(other);
	}
	public multiply(other: TVec2Source): this {
		return this.clone.muled(other);
	}
	public crossed(other: TVec2Source): this {
		return this.muled(other);
	}
	public cross(other: TVec2Source): this {
	...
	public divided(other: TVec2Source): this {
		return this.dived(other);
	}
	public divide(other: TVec2Source): this {
		return this.clone.dived(other);
	}
	...
	public dist(other: TVec2Source): number {
		return new Vec2(other).minused(this).len;
	}
	public distance(other: TVec2Source): number {
		return this.dist(other);
	}

	public sqDist(other: TVec2Source): number {
		return new Vec2(other).minused(this).sqLen;
	}
	public sqDistance(other: TVec2Source): number {
		return this.sqDist(other);
	}
	public squareDistance(other: TVec2Source): number {
		return this.sqDist(other);
	}

	public copy(other: TVec2Source): this {
		this[0] = other[0];
		this[1] = other[1];
		return this;
	}
	...
	public get orthoClockwise(): Vec2 {
		return this.ortho;
	}
	...
	public lerp(other: TVec2Source, t: number): this {
		return this.clone.lerped(other, t);
	}

	public reflected(normal: Vec2): this {
