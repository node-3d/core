...
export class Drawable {
	...
	public set screen(_value: Screen) { /* for convenience of passing Drawable as opts */ }
	
	public get mat(): TMaterialWithCoreProps { return this._mesh.material; }
	public get geo(): THREE.BufferGeometry { return this._mesh.geometry; }
	public get mesh(): TDrawableMesh { return this._mesh; }
	...
	public get pos(): Vec2 { return this._pos.xy; }
	...
	public get color(): Color | null { return this._color; }
	...
	public _build(opts: TDrawableOpts): TDrawableMesh {
		return new this.screen.three.Mesh(this._geo(opts), this._mat(opts)) as unknown as TDrawableMesh;
	}
	...
	public updateGeo(): void {
		...
		(this._mesh.geometry as THREE.BufferGeometry & { needsUpdate?: boolean }).needsUpdate = true;
	}
