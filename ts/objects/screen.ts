...
export class Screen extends EventEmitter {
	...
	public get context(): TWebgl { return this._gl; }
	public get three(): TThree { return this._three; }
	
	public get renderer(): THREE.WebGLRenderer { return this._renderer; }
	public get scene(): THREE.Scene { return this._scene; }
	public get camera(): TScreenCamera { return this._camera; }
	
	public get document(): TDocument { return this._doc; }
	public get canvas(): TDocument { return this._doc; }
	
	public get width(): number { return this._doc.width; }
	public get height(): number { return this._doc.height; }
	public get w(): number { return this._doc.width; }
	public get h(): number { return this._doc.height; }
	public get size(): THREE.Vector2 { return new this._three.Vector2(this.w, this.h); }
	
	public get title(): string { return this._doc.title; }
	public set title(value: string) { this._doc.title = value || 'Untitled'; }
	
	public get icon(): TIcon { return this._doc.icon; }
	public set icon(value: TIcon) { this._doc.icon = value || null; }
	...
	public get mode(): TDocument['mode'] { return this._doc.mode; }
	public set mode(value: TDocument['mode']) { this._doc.mode = value; }
	...
	public _bindEvents(): void {
		for (const type of ['keydown', 'keyup', 'mousedown', 'mouseup', 'mousemove', 'mousewheel']) {
	...
	private _createCamera(opts: TScreenOpts): TScreenCamera {
		...
		const camera = new this._three.PerspectiveCamera(
			fov ?? DEFAULT_FOV, this.w / this.h, near ?? DEFAULT_NEAR, far ?? DEFAULT_FAR,
		) as TScreenCamera;
