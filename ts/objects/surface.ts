...
export class Surface extends Rect {
	...
	public get canvas(): TDocument { return this.screen.canvas; }
	public get camera(): THREE.PerspectiveCamera { return this._camera; }
	public get scene(): THREE.Scene { return this._scene; }
	public get renderer(): THREE.WebGLRenderer { return this.screen.renderer; }
	public get context(): TWebgl { return this.screen.context; }
	public get document(): TDocument { return this.screen.document; }
	
	public get title(): string { return this.screen.title; }
	public set title(value: string) { this.screen.title = value; }
	
	public get fov(): number { return this.screen.fov; }
	public set fov(value: number) { this.screen.fov = value; }
	
	public override get size(): Vec2 { return super.size; }
